...
SOURCE_DIR="${REPO_ROOT}/tools/tree-sitter"
TARGET_DIR="${HOME}/.config/nvim/treesitter/brash"
...
Sync Brash tree-sitter parser files into Neovim local parser directory.
